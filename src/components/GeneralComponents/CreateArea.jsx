...
function CreateArea(props) {
    ...
    return (
    <div>
        <div className="modal fade" id="exampleModalarea1" tabIndex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">    
            <div className="modal-dialog modal-lg" role="document">
                <div className="modal-content" id="addModal">
                    <div className="modal-header" id="agregar">
                        <h5 style={{color: "#545454"}} className="modal-title" id="exampleModalarea1">Agregar</h5>
                    ...
                    <div style={{fontSize: "12px"}} className="modal-body">
                        <table>
                            <tr>
                                ...
                                <td style={{paddingRight: "5px", paddingBottom: "20px"}}>
                                    <p style={{marginBottom: "0"}}>Administrador: </p>
                                    <textarea 
                                        id="quantityField"
                                        name="quantityField"
                                        onChange={handleChange}
